...
/**
 * Klasinn er controller fyrir dialoginn sem tekur við gögnum um Person
 * Erfir (extends) frá Dialog<Person>
 */
...
public class PersonDialog extends Dialog<Person> {
    ...
    public PersonDialog(Person person) {
        ...
        this.person = person;
        // Byggir dialog-inn með því m.a. að lesa inn DialogPane hlut
        buildUI();
        // Setur teninginu á milli viðmóts (þessa klasa) og vinnslu (hér Person)
        setPropertyBindings();
        // Skilgreinir hverju á að skila (Person) þegar glugga er lokað
        setResultConverter();
    }

    /**
     * Lesa inn .fxml skrána fyrir dialog-inn (DialogPane)
     *
    ...
    private void buildUI() {
        ...
        // atburðahandler settur á ok hnappinn
    ...
    /**
     * Setja upp bindingar í báðar áttir á milli vinnslu (Person) og notendaviðmóts (controller)
     */
    ...
    /**
     * setja upp gagnaflutning frá dialog yfir á þann hlut sem opnar dialog-inn
     */
    private void setResultConverter() {
        // Lambda fall skilgreint sem er af taginu Callback <ButtonType, Person>,
        // þ.e. tekur inn ButtonType og skilar Person
